    ...
    <div className="home-container">
      ...
      <section className="hero">
        <div className="hero-text">
          <h1 className="fade-in">Your Kitchen, Optimized.</h1>
          <br />
          <p className="hero-text1 fade-in">Pantry perfection at your fingertips.</p>
          <p className="hero-text2 fade-in">Transform your kitchen management with our intelligent pantry system.</p>
          <Link to="/pantry" className="btn fade-in">Discover!</Link>
        </div>
        <div className="hero-image">
          <img src="assests/hero-image.png" alt="Pantry System" className="fade-in" />
        </div>
      </section>

      {/* 🔹 Features Section */}
      <section className="features">
        <div className="feature-card left fade-in-up">
        ...
        <div className="feature-card right fade-in-up">
          <div className="feature-content">
